...
Another useful algebraic construction is the [Chow ring of a matroid][AHK] which is a quotient of _\mathbb{Q}[\mathbf{x}]_ with one variable for every nonempty proper flat.
